  ...
  const loadDecisions = async (overrideValues = {}) => {
    try {
      ...
      if (code === 401) {
        ...
        setError(
          "You are not authorized to view decisions."
        );
      } else if (code === 404) {
        setError(
  ...
  return (
    <div className="decision-page">
      ...
      <PageHeader
        ...
        subtitle="View, search, filter and manage organizational decisions"
        action={
          <Button
            onClick={() =>
      ...
      <Card title="Search & Filters">
        ...
        <div className="decision-filters">
          ...
          {/* SORT BY */}
          <div className="filter-group">
            <label htmlFor="decision-sort-by">
              Sort By
            </label>
          ...
          {/* SORT ORDER */}
          <div className="filter-group">
            <label htmlFor="decision-sort-order">
              Sort Order
            </label>

            <select
              id="decision-sort-order"
              value={sortOrder}
              onChange={(event) =>
      ...
      {loading ? (
        ...
        <EmptyState
          ...
          message="No decisions match your current search or filters."
          action={
            <Button
              onClick={() =>
                navigate("/decisions/create")
