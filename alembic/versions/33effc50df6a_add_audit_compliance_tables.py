...
Revision ID: 33effc50df6a
Revises: efbef8818d47
Create Date: 2026-09-02 21:35:00.052276
...
revision: str = '33effc50df6a'
down_revision: Union[str, Sequence[str], None] = 'efbef8818d47'
...
def upgrade() -> None:
    ...
    op.create_index('ix_access_logs_user_resource', 'access_logs', ['user_id', 'resource_type', 'resource_id'], unique=False)
    ...
    op.create_index('ix_audit_logs_user_entity', 'audit_logs', ['user_id', 'entity_type', 'entity_id'], unique=False)
    ...
    op.create_index('ix_security_logs_created_event', 'security_logs', ['created_at', 'event_type'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index('ix_security_logs_created_event', table_name='security_logs')
    ...
    op.drop_index('ix_access_logs_user_resource', table_name='access_logs')
